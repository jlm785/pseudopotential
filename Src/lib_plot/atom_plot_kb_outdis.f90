...
subroutine atom_plot_kb_outdis(iowrite, iocomm, iotmp,                   &
     numw, numb, nump, nftp,                                             &
     iw, labelw, lo_w,                                                   &
     ib, labelb, lo_b,                                                   &
     ip, labelp,                                                         &
...
! input
  ...
  character(len=12), intent(in)     ::  labelv                           !<  label local potential
...
! counters
  ...
  write(iowrite,*)
  write(iowrite,*)'PSEUDO AND BASIS WAVE-FUNCTIONS'
  write(iowrite,*)
...
! loop over angular momentum of basis functions
  ...
  do l = 0,lmax
    ...
    if(nlabel > 0) then
      ...
      call atom_plot_command(iocomm, sfname, nlabel, zion, 0, .FALSE.,   &
...
! Local potetntial
  ...
  write(iowrite,*)
  write(iowrite,*)'LOCAL POTENTIAL'
  write(iowrite,*)
  write(iowrite,*)'REAL SPACE'
  write(iowrite,*)
  ...
  call atom_plot_command(iocomm, sfname, 1, zion, 0, .FALSE.,            &
...
! projectors real space
  ...
  if(nump > 0) then
    ...
    write(iowrite,*)
    write(iowrite,*)'KLEINMAN & BYLANDER OPERATORS (PROJECTORS)'
    write(iowrite,*)
    write(iowrite,*)'REAL SPACE'
    write(iowrite,*)
...
! projetors reciprocal space
  ...
  if(nump > 0) then
    ...
    write(iowrite,*)
    write(iowrite,*)'RECIPROCAL SPACE'
    write(iowrite,*)
    ...
    call atom_plot_command(iocomm, sfname, nftp, zion, 0, .FALSE.,         &
...
! integral kinetic energy
  ...
  write(iowrite,*)
  write(iowrite,*)'DIFFERENCE OF INTEGRAL OF KINETIC ENERGY'
  write(iowrite,*)
  write(iowrite,*)'RECIPROCAL SPACE'
  write(iowrite,*)
...
end subroutine atom_plot_kb_outdis
